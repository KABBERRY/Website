 ...
 *
 */
class CRYPTOIGOFramework_Option_Sorter extends CRYPTOIGOFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : esc_html__( 'Enabled Modules', 'cryptoigo-framework' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : esc_html__( 'Disabled Modules', 'cryptoigo-framework' );

    echo '<div class="cryptoigo-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="cryptoigo-enabled">';
    if( ! empty( $enabled ) ) {
    ...
    echo '<ul class="cryptoigo-disabled">';
    if( ! empty( $disabled ) ) {
