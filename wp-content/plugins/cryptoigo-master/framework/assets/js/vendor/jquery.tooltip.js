...
+function ($) {
  ...
  CSTooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="cryptoigo-tooltip" role="tooltip"><div class="cryptoigo-tooltip-arrow"></div><div class="cryptoigo-tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  CSTooltip.prototype.setContent = function () {
    ...
    $tip.find('.cryptoigo-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
  ...
  CSTooltip.prototype.arrow = function () {
    return (this.$arrow = this.$arrow || this.tip().find('.cryptoigo-tooltip-arrow'))
  }
