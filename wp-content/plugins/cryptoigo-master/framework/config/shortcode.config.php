...
$options[]     = array(
  ...
  'shortcodes' => array(
    ...
    // begin: shortcode
    array(
      'name'          => 'CRYPTOIGO_advanced_3',
      'title'         => 'Duplicate Group Shortcode',
      'view'          => 'clone',
      'clone_id'      => 'CRYPTOIGO_advanced_3_sub',
      'clone_title'   => 'Add New',
      'fields'        => array(
...
CRYPTOIGOFramework_Shortcode_Manager::instance( $options );
