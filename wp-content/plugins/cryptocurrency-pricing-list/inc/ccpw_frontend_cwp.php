...
$data_url = 'https://min-api.cryptocompare.com/data/pricemulti?fsyms='.$data_url_currency_2.'&tsyms='.$data_url_currency_1;
...
$data_all_currencies_raw = json_decode($data_url_responsed, true);
