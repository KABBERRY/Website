...
define ('ccpw_version', '1.4');
//define plugin url global
define('ccpw_url', plugin_dir_url( __FILE__ ));
define('ccpw_request_url', "https://www.premium-themes.co");

//include source files
require_once( dirname( __FILE__ ) . '/inc/ccpw_admin_page.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_frontend_all-currencies.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_fontend_calculator.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_frontend_cwp.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_frontend_ticker.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_frontend_price_chart.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_fontend_changelly_widget.php' );
require_once( dirname( __FILE__ ) . '/inc/ccpw_frontend_news_ticker.php' );
...
function ccpw_update_db_check() {
	...
	update_option('ccpw_plugin_version', ccpw_version);
		...
		if(count($ccpw_check_table)>0){
			...
			$ccpw_coinlist_response = wp_remote_get($ccpw_coinlist_url);
